...
def clean_data(data_set_name):
    ...
    elif data_set_name == "book_crossing":
        data = pd.read_csv(f"{base_path_original}/book_ratings.dat", sep="\t", engine="python")
    ...
    elif data_set_name == "Loc-brightkit":
        data = pd.read_csv(f"{base_path_original}/Brightkite_totalCheckins.txt",
